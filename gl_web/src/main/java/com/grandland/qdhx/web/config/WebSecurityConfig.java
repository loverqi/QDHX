...
import com.grandland.qdhx.web.security.lnterceptor.DynamicFilterSecurityInterceptor;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        //设置忽略资源
        web.ignoring().antMatchers("/views/login.do", "/WEB-INF/views/login.jsp", "/static/**", "/druid/**",
